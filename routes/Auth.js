...
class AuthenticationRouteConfigurator {
    configure(path, app) {
        router.get('/', (req, res) => {
            res.json(req.user);
        });
        ...
        router.get('/github', passport.authenticate('github', { scope: ['user:email', 'read:org'] }), (req, res) => {
...
exports.default = new AuthenticationRouteConfigurator();
